...
public class UserController extends BaseApiController {
    ...
    @Autowired
    public UserController(UserService userService, UserEventLogService userEventLogService, AuthenticationService authenticationService, UsersService usersService, UrlService urlService) {
