...
public class UserController extends BaseApiController {
    ...
    @Autowired
    public UserController(UserService userService, UserEventLogService userEventLogService, MessageService messageService, UserCredentialService userCredentialService, AuthenticationService authenticationService, ApplicationEventPublisher eventPublisher) {
    ...
    public RestResponse<List<UserCredential>> listCredential(){
        Integer id = getCurrentUser().getId();
       List<UserCredential> userCredentials = userCredentialService.listCredential(id);
        return RestResponse.ok(userCredentials);
